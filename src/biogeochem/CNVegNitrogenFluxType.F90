module CNVegNitrogenFluxType
  ...
  type, public :: cnveg_nitrogenflux_type
     ...
     real(r8), pointer :: biomassn_to_biofuelprodn_patch            (:)     ! patch biomass N to biofuel product pool (gN/m2/s)
     real(r8), pointer :: biomassn_to_biofuelprodn_col              (:)     ! col biomass N to biofuel product pool (gN/m2/s)
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%biomassn_to_biofuelprodn_patch            (begp:endp)) ; this%biomassn_to_biofuelprodn_patch            (:) = nan
    allocate(this%biomassn_to_biofuelprodn_col              (begc:endc)) ; this%biomassn_to_biofuelprodn_col              (:) = nan
...
! End BACKWARDS_COMPATIBILITY(wrw, 2018-06-28) re. issue #426
  ...
  subroutine SetValues ( this, &
    ...
    do fi = 1,num_patch
       ...
       this%biomassn_to_biofuelprodn_patch(i)            = value_patch
    end do
    ...
    do fi = 1,num_column
       ...
       this%biomassn_to_biofuelprodn_col(i)  = value_column
