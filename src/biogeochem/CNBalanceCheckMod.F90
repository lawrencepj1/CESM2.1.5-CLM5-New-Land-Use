...
contains
  ...
  subroutine CBalanceCheck(this, bounds, num_soilc, filter_soilc, &
    ...
    associate(                                                                            & 
         ...
         biomassc_to_biofuelprodc =>   cnveg_carbonflux_inst%biomassc_to_biofuelprodc_col, & ! Input:  [real(r8) (:) ]  (gC/m2/s) biomass C to biofuel product pools
      ...
      if (err_found) then
         ...
         write(iulog,*)'biomassc_to_biofuelprodc = ',biomassc_to_biofuelprodc(c)*dt
  ...
  subroutine NBalanceCheck(this, bounds, num_soilc, filter_soilc, &
    ...
    associate(                                                                             & 
         ...
         biomassn_to_biofuelprodn => cnveg_nitrogenflux_inst%biomassn_to_biofuelprodn_col , & ! Input:  [real(r8) (:) ]  (gN/m2/s) biomass N to biofuel product pools
